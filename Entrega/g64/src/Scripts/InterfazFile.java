 ...
 * @version 2.0
 * @author Admin
 * @implNote Interfaz del programa
 * @see cambiar numero de grupo, ya que es el proyecto del año pasado con mi grupo empanado :D
 *
 */
public class InterfazFile {
	...
	private void initialize() {
		...
		frmPracticapdl.setTitle("PracticaPDL Grupo64");
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(!textField_1.getText().isEmpty()){
					...
					try {
						//Comenzamos a ejecutar el anï¿½lisis
		...
		txtpnImportanteSeCrear.setText("Importante: \r\nSe crear\u00E1 una carpeta \"Resultados Grupo64\"  con los archivos resultantes, si estos archivos existen previamente, ser\u00E1n sobreescritos");
